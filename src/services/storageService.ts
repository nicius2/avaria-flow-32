...
export type DamageReport = {
    ...
    serialNumber: string; // Identificador único do item físico
    productName: string;
    damage: string;
    discount: string;
    seller: string;
...
const INITIAL_DAMAGE_REPORTS: DamageReport[] = [
    { id: 1, code: "TV-LG-55", serialNumber: "SN-951753852", productName: "Smart TV LG 55” 4K UHD", damage: "Arranhão profundo na lateral.", discount: "15%", seller: "João Silva", date: "2025-09-08T12:00:00.000Z", category: "Eletrônicos", newPrice: "R$ 2.549,15", originalPrice: "R$ 2.999,00", photoUrl: "https://placehold.co/600x400/cccccc/ffffff?text=Arranhao+na+Tela" },
    { id: 2, code: "GEL-BRA-01", serialNumber: "SN-789456123", productName: "Geladeira Brastemp Frost Free", damage: "Embalagem danificada.", discount: "10%", seller: "Maria Santos", date: "2025-09-07T12:00:00.000Z", category: "Eletrodomesticos", newPrice: "R$ 3.149,10", originalPrice: "R$ 3.499,00", photoUrl: "https://placehold.co/600x400/cccccc/ffffff?text=Embalagem+Danificada" },
    { id: 3, code: "NOTE-DELL-I15", serialNumber: "SN-BRX5487A", productName: "Notebook Dell Inspiron 15", damage: "Tela com pixel queimado.", discount: "20%", seller: "Pedro Costa", date: "2025-09-06T12:00:00.000Z", category: "Eletrônicos", newPrice: "R$ 3.039,20", originalPrice: "R$ 3.799,00", photoUrl: "https://placehold.co/600x400/cccccc/ffffff?text=Defeito+Puxador" },
];
...
export const addDamageReport = (newReportData: Omit<DamageReport, 'id'>): void => {
    ...
    const updatedReports = [newReport, ...currentReports]; // Adiciona o novo no início
...
export const getDashboardStats = () => {
    ...
    return {
        ...
        pendingWarnings: 3, // Valor estático por enquanto
